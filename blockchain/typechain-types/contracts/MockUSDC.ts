...
export namespace FaucetUsedEvent {
...
export interface MockUSDC extends BaseContract {
  ...
  canUseFaucet: TypedContractMethod<
    [user: AddressLike],
    [[boolean, bigint] & { canUse: boolean; cooldownRemaining: bigint }],
    "view"
  >;
  ...
  lastFaucetRequest: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "lastFaucetRequest"
  ...
  getEvent(
    ...
    FaucetUsedEvent.InputTuple,
    FaucetUsedEvent.OutputTuple,
    FaucetUsedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "FaucetUsed(address,uint256)": TypedContractEvent<
      FaucetUsedEvent.InputTuple,
      FaucetUsedEvent.OutputTuple,
      FaucetUsedEvent.OutputObject
    >;
    FaucetUsed: TypedContractEvent<
      FaucetUsedEvent.InputTuple,
      FaucetUsedEvent.OutputTuple,
      FaucetUsedEvent.OutputObject
    >;
